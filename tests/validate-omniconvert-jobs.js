/**
 * Omniconvert Job Validator - Check and remove expired jobs
 * 
 * Validates all Omniconvert jobs from peviitor API and deletes expired (404) ones from SOLR.
 * Run: node tests/validate-omniconvert-jobs.js
 */
...
const COMPANY_NAME = "OMNICONVERT SRL";

/**
 * Get all jobs for Omniconvert from peviitor API
 */
...
async function main(args) {
  ...
  console.log("Omniconvert Job Validator");
  console.log("=".repeat(50));
