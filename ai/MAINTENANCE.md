...
```bash
gh issue list --repo peviitor-scrapers/omniconvert-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "OMNICONVERT", not the old template
